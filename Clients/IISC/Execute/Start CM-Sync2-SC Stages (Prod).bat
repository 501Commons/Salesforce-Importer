...
REM call C:\repo\Salesforce-Importer-Private\Clients\IISC\importer.bat SYNC-Insert Prod Cloud

@REM Run SC Importer Update
REM call C:\repo\Salesforce-Exporter-Private\Clients\IISC\importer.bat SYNC-Update1of2 Prod Cloud
