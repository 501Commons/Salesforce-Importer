...
set PYTHON_HOME=C:\repo\Salesforce-Importer\dependencies\Python\2.7.16
echo exporter: setting PYTHON_HOME to %PYTHON_HOME%
set SF_DATALOADER=C:\repo\Salesforce-Importer\dependencies\salesforce.com\dataloader\v44
